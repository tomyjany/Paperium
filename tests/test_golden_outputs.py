...
GOLDEN_OUTPUTS = {
    ...
    Path(
        "paper/work/inventories/questions/q001-throughput/experiments/"
        "exp005-unsupported-and-previews.json"
    ): (
        GOLDEN_DIR / "paper/work/inventories/questions/q001-throughput/experiments/"
        "exp005-unsupported-and-previews.json",
    ...
    Path(
        ...
        GOLDEN_DIR / "paper/work/evidence/questions/q001-throughput/experiments/"
        "exp005-unsupported-and-previews.json",
...
def test_compact_fixture_generated_outputs_match_goldens_and_are_reproducible(tmp_path):
    ...
    for generated_path, (golden_path, schema_name) in GOLDEN_OUTPUTS.items():
